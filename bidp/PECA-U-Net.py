...
import numpy as np
from vgg_models import Back_VGG
# from swin_transformer_unet_skip_expand_decoder_sys import SwinTransformerSys
from RECA_Transformer import  SwinTransformerSys
import torch
from torch import nn
from ca import InvertedResidual
...
class PECA_U_Net(nn.Module):
    def __init__(self, num_category):
        super(PECA_U_Net, self).__init__()
        ...
        self.scores1 = InvertedResidual(1024, num_category*4, 1,expand_ratio=2)  #
        self.scores2 = InvertedResidual(512, num_category, 1,expand_ratio=2)
        self.scores3 = InvertedResidual(256, num_category, 1,expand_ratio=2)
        self.scores4 = InvertedResidual(128, num_category, 1,expand_ratio=2)
        self.scores5 = InvertedResidual(64, num_category, 1,expand_ratio=2)
        ...
        self.relu=nn.ReLU()
        self.fused_edge_sal = nn.Conv2d(64, 2, kernel_size=3, padding=1, bias=False)
        self.jinglian=SwinTransformerSys(img_size=224,in_chans=2,num_classes=2)
